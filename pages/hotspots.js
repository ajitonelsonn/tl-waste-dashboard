...
export default function PublicHotspotsPage() {
  ...
  const filteredHotspots = hotspots ? hotspots.filter(hotspot => {
    // Search filter
    ...
    const matchesSeverity = !filters.severity || 
      (filters.severity === 'high' && parseFloat(hotspot.average_severity) >= 7) ||
      (filters.severity === 'medium' && parseFloat(hotspot.average_severity) >= 4 && parseFloat(hotspot.average_severity) < 7) ||
      (filters.severity === 'low' && parseFloat(hotspot.average_severity) < 4);
  ...
  return (
    <ModernLayout>
      <Head>
        ...
        <meta name="description" content="Public information on waste hotspots in Timor-Leste" />
      </Head>
      ...
      <div className="px-6 py-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-600">
              High-concentration areas of waste incidents requiring public attention
            </p>
          </div>
        ...
        {refreshing && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4 flex items-center shadow-sm">
            ...
            <span className="text-sm text-red-700">Refreshing hotspot data...</span>
          </div>
        )}
        ...
        {hotspotsError && (
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-md mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-red-700">Error loading hotspots data. Please try again.</p>
                <button 
                  onClick={handleRefresh} 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 bg-white rounded-xl shadow-sm overflow-hidden h-fit">
            <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
              <div className="flex items-center">
                ...
                <h2 className="text-lg font-medium text-gray-900">Active Hotspots</h2>
              </div>
                ...
                {filteredHotspots.map((hotspot) => (
                  <div 
                    ...
                    className={`p-4 hover:bg-red-50 transition-colors duration-200 cursor-pointer
                      ${selectedHotspot?.hotspot_id === hotspot.hotspot_id ? 'bg-red-50 border-l-4 border-red-500 pl-3' : 'border-l-4 border-transparent pl-3'}`}
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="flex items-center text-sm text-gray-500">
                          ...
                          <span>Active since {formatDate(hotspot.first_reported)}</span>
                        </div>
                      </div>
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600">
                          Severity: 
                          <span className={`font-medium ml-1 ${getSeverityColorClass(hotspot.average_severity)}`}>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
              <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
                <div className="flex items-center">
                  ...
                  <h2 className="text-lg font-medium text-gray-900">Hotspot Location</h2>
                </div>
                <Link 
                  href="/map" 
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                <div className="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <h2 className="text-lg font-medium text-gray-900">Hotspot Details</h2>
                  </div>
                  <button
                ...
                <div className="p-4 border-b border-gray-100">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-red-50 rounded-lg p-3 border border-red-100">
                      <h3 className="text-xs font-medium text-red-700 uppercase tracking-wider mb-1">Total Reports</h3>
                      <div className="text-2xl font-bold text-gray-900">{selectedHotspot.total_reports}</div>
                    </div>
                    <div className="bg-red-50 rounded-lg p-3 border border-red-100">
                      <h3 className="text-xs font-medium text-red-700 uppercase tracking-wider mb-1">Average Severity</h3>
                      <div className="text-2xl font-bold text-gray-900">
                        {parseFloat(selectedHotspot.average_severity).toFixed(1)}/10
                      </div>
                    </div>
                    <div className="bg-red-50 rounded-lg p-3 border border-red-100">
                      <h3 className="text-xs font-medium text-red-700 uppercase tracking-wider mb-1">Radius</h3>
                      <div className="text-2xl font-bold text-gray-900">
                        {(parseFloat(selectedHotspot.radius_meters) / 1000).toFixed(1)} km
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  {reportsLoading ? (
                              ...
                              <td className="px-3 py-4 whitespace-nowrap">
                                {report.severity_score ? (
                                  <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                    report.severity_score > 7 ? 'bg-red-100 text-red-800' :
                                    report.severity_score > 4 ? 'bg-yellow-100 text-yellow-800' :
                    ...
                    <div className="flex justify-center items-center h-32 flex-col">
                      ...
                      <p className="text-gray-500">No reports available for this hotspot</p>
                    </div>
                  )}
                </div>
                ...
                <div className="px-4 py-3 bg-blue-50 border-t border-blue-100">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-blue-800">Public Health Advisory</h4>
                      <p className="mt-1 text-sm text-blue-700">
                        This hotspot may contain hazardous waste materials. If you live in or visit this area, 
                        please take appropriate precautions and report any new waste sightings.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {!selectedHotspot && !hotspotsLoading && hotspots && hotspots.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm overflow-hidden h-[300px] flex items-center justify-center">
                <div className="text-center max-w-md px-6">
                  <MapPin className="h-12 w-12 text-gray-300 mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No hotspot selected</h3>
                  <p className="text-gray-500 mb-4">
                    Select a hotspot from the list to see its details and reports.
                  </p>
                </div>
              </div>
            )}
        ...
        <div className="mt-8 bg-white rounded-xl shadow-sm p-6 border-t-4 border-red-500">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Understanding Waste Hotspots</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-2">What is a Waste Hotspot?</h3>
              <p className="text-gray-600 mb-4">
                A waste hotspot is an area with a high concentration of improperly disposed waste reports. 
                These areas often require community attention and coordinated cleanup efforts.
              </p>
              <h3 className="text-lg font-medium text-gray-900 mb-2">How are Hotspots Determined?</h3>
              <p className="text-gray-600">
                Hotspots are automatically identified based on the density, severity, and frequency of 
                waste reports in a specific geographic area. The system continuously monitors for new 
                emerging hotspots.
              </p>
            </div>
            <div>
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-2">
                ...
                <li>Participate in community cleanup events targeting these hotspots</li>
                <li>Raise awareness about waste management in your community</li>
                <li>Follow proper waste disposal guidelines to prevent new hotspots</li>
              </ul>
              <div className="mt-4">
                <Link
                  href="/about"
